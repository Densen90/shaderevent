...
#include "header_shader1.h"
#include "header_shader2.h"
#include "header_shader3.h"
#include "header_shader4.h"
#include "header_shader5.h"
#include "header_shader6.h"
...
float dist(vec3 p)
{
	...
	cubePos = rotate(cubePos, vec3(0, 0, 0));
...
void main()
{
	...
	if(res.a==1.0)
	{
		...
		if(sideHitShaderOne) 
		{
			currentCol = getShader1Color(iResolution.xy, iGlobalTime-uStartRotationTime);
		}
		else if(sideHitShaderTwo)
		{
			currentCol = getShader2Color(iResolution.xy, iGlobalTime-uStartRotationTime);
		}
		...
		else
		{
			...
			currentCol *= vec4(lighting(res.xyz, cam.dir, n), 1.0);
		}
	}
